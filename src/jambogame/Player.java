...
public class Player {
	...
	void playerCollisionBorder() {
		if (x > screenWidth - 41) {
			x = screenWidth - 41;
			speedx = 0;
		}//41 becaus program made screenWidth outside the screen... it slightly bounces the ball back into play
		if (x < 0) {
			x = 0;
			speedx = 0;
		}//slight bounce after hitting 
	...
	public void right() {//should move right as long as it is not on the right edge
		if (x < screenWidth - playerWidth / 2) {
			speedx = normSpeed;
		}
	}
